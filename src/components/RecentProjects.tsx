                    ...
                    <li>
                        <div className="project-card">
                            ...
                            <figure className="card-banner img-holder" style={{ width: 510, height: 700 }}>
                                ...
                                <img src={project} loading="lazy" alt="Designing a better cinema experience" className="img-cover"></img>
                            </figure>
                    ...
                    <li>
                        <div className="project-card">
                            ...
                            <figure className="card-banner img-holder" style={{ width: 510, height: 700 }}>
                                ...
                                <img src={project} width="510" height="700" loading="lazy" alt="Designing a better cinema experience" className="img-cover"></img>
                            </figure>
